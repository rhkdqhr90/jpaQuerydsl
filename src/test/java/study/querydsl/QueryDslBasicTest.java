...
//        List<Member> results = result.getResults();
    ...
    public void dynamicQuery_BooleanBuilder(){
        ...
        List<Member> result = getSearchMember1(usernameParam, ageParam);
    ...
    private List<Member> getSearchMember1(String usernameParam, Integer ageParam) {
    ...
    private BooleanExpression getUsernameEq(String usernameParam) {
